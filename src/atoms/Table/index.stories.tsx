    ...
    compositions: [
      {
        ...
        material: {
          ...
          material: {
            ...
            name: {
              locales: [{ text: "Recycled Cotton", localeName: "en" }],
            },
            specifications: [],
            unit: "yd",
            rules: null,
...
const productColumns = [
  {
    ...
    sorter: (a: any, b: any) =>
      a.product?.name.toLowerCase().localeCompare(b.product.name.toLowerCase()),
  },
  {
    title: "product:listing.active",
    dataIndex: "isActive",
    render: (_: any, item: any) => {
      return <Text>{item.product?.isActive ? "Active" : "Inactive"}</Text>;
    },
  },
  {
  ...
  },
  {
    ...
    dataIndex: ["product", "category", "base", "name", "locales", "0", "text"],
    render: (_: any, item: any) => {
      return (
        <Text>
          {
      ...
      rules: [
        {
          pattern: /^\d*\.?\d*$/,
          message: (
            <Tooltip title="">Please input a positive number only.</Tooltip>
          ),
        },
      ],
    },
