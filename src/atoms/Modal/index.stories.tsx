        ...
        component: (
          <Select
            options={Object.values(SupportDocType)
              .filter((x) => x !== SupportDocType.PRODUCT_CERTIFICATE)
              .map((x) => ({
                label: x,
                value: x,
                key: x,
  ...
  const content = [
    {
      title: (
        <Text style={{ wordBreak: "break-all" }}>
          "FFirstFirstFirstFirstFirst FirstirstFirstFirstFirstFirstFirst"
        </Text>
      ),
      content: (
        <div style={{ display: "flex", flexDirection: "column" }}>
          <Form form={form}>
            <FormItem
              required
              label="Test"
              rules={[{ required: true, message: "bro" }]}
            >
              <Input />
            </FormItem>
          </Form>
    ...
    },
    {
      title: "Second",
      content: (
        <AddTable form={form} columns={columns} scroll={{ x: "max-content" }} />
      ),
    },
  ];
